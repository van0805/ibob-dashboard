...
HOLIDAY_PERIODS = {
    ...
    'outbound': {
        ...
        'Labour Day (劳动节)': {
            2024: {'start':'2024-05-01','end':'2024-05-01', 'note':'1d  May 1 (Wed) only'},
            2025: {'start':'2025-05-01','end':'2025-05-01', 'note':'1d  May 1 (Thu) only'},
        ...
        'National Day (国庆)': {
            2024: {'start':'2024-10-01','end':'2024-10-01', 'note':'1d  Oct 1 (Tue) only'},
            2025: {'start':'2025-10-01','end':'2025-10-01', 'note':'1d  Oct 1 (Wed) only'},
            2026: {'start':'2026-10-01','end':'2026-10-01', 'note':'1d  Oct 1 (Thu) only'},
        },
        'Christmas (圣诞)': {
            2024: {'start':'2024-12-25','end':'2024-12-26', 'note':'2d  Dec 25 (Wed) – Dec 26 (Thu)'},
